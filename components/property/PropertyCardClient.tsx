...
// Client-rendered mirror of PropertyCard, for lists built from client-fetched
// data (e.g. favorites read from localStorage) — a Client Component can't
// render an async Server Component at runtime, so this can't just reuse
// PropertyCard directly.
